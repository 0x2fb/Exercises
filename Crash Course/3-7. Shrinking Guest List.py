...
print('Oh no, the table isn\'t as big as I expected.')
print(f'I\'m sorry, {guest_list.pop()}, but you need to come another time.')
print(f'I\'m sorry, {guest_list.pop()}, but you need to come another time.')
print(f'I\'m sorry, {guest_list.pop()}, but you need to come another time.')
print(f'I\'m sorry, {guest_list.pop()}, but you need to come another time.')
print(f'You\'re still invited, {guest_list[0]}!')
print(f'You\'re still invited, {guest_list[1]}!')
del guest_list[1]
del guest_list[0]
print(guest_list)